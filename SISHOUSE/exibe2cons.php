...
echo "<caption><b><font size=3 color='#5698bb' face=arial>CADASTRO DE CLIENTES - Clique no registro que deseja EDITAR</font></b></caption>";
...
<th><font size=3 color='#5698bb' face=arial> EDITAR </font></th>";
...
for ($i=0; $i<$numresultado; $i++)
 ...
 echo "</form> <form action='editarcons.php' method='post'>"; 
echo "<tr>";
...
<td><INPUT TYPE=HIDDEN NAME='id' value='$id'><input type='submit' value='Editar'></td>";
echo '</tr></center>';
echo "</form>";
}
